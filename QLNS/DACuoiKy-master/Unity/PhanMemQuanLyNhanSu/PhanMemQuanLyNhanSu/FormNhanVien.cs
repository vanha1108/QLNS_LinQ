...
namespace PhanMemQuanLyNhanSu
{
    public partial class FormNhanVien : Form
    {
        ...
        BLChamCong dbCC = new BLChamCong();
        void LoadData()
        {
            try
            {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            if (Them)
            {
                try
                {
                    ...
                    blCC.ThemChamCong(this.txtMaNV.Text, this.txtTenNV.Text, this.cbBLuong.Text, ref err);
            ...
            else // sửa đổi
            {
                try
                {
                    ...
                    blNv.CapNhatNhanVien(this.txtMaNV.Text,
                     ...
                     ref err);
                    BLChamCong blCC = new BLChamCong();
                    blCC.CapNhatChamCong(this.txtMaNV.Text, this.txtTenNV.Text, this.cbBLuong.Text, ref err);
                    //load lại dữ liệu
                    LoadData();
                    //Thông báo
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (traloi == DialogResult.OK)
            {
                try
                {
                    ...
                    dbCC.XoaChamCong(ref err, strNhanVien);
